...
<script>
  ...
  <form action="choose_data" method="post">
  <!-- 中华网BBS -->
  <div id="tb_chinabbs" class="quick-actions_homepage" style="margin:0px;padding-top:-20px;">
    ...
    <!-- 中华网 - 评论 -->
    <div id="bbs_china_comment_disid" style="display: none">
    ...
    <!-- 中华网 - 发布 -->
    <div id="bbs_china_post_disid" style="display: none">
  ...
  <div id="tb_doubangroup" class="quick-actions_homepage" style="margin:0px;padding-top:-20px; display: none">
    ...
    <!-- 豆瓣小组 - 作者 -->
    <div id="douban_group_author_disid" style="display: block">
    ...
    <!-- 豆瓣小组 - 评论 -->
    <div id="douban_group_comment_disid" style="display: none;">
    ...
    <!-- 豆瓣小组 - 粉丝 -->
    <div id="douban_group_fans_disid" style="display: none;">
    ...
    <!-- 豆瓣小组 - 发布 -->
    <div id="douban_group_post_disid" style="display: none;">
  ...
  <div id="tb_people" class="quick-actions_homepage" style="margin:0px;padding-top:-20px; display: none">
    ...
    <div method="post" id="people_news_disid">
