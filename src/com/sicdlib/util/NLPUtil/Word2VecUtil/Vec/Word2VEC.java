package com.sicdlib.util.NLPUtil.Word2VecUtil.Vec;
...
public class Word2VEC {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 learn.learnFile(new File("data/wiki_chinese_preprocessed.simplied.txt"));
		 learn.saveModel(new File("data/wikichinese.model"));
